  ...
  return (
    <Drawer open={open} onOpenChange={setOpen}>
      <DrawerTrigger asChild>
        <button
          className="flex h-9 w-full items-center justify-between rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 text-sm text-gray-900 dark:text-gray-100 select-none min-h-[44px]"
      ...
      <DrawerContent className="dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="px-4 pb-8 max-h-[60vh] overflow-y-auto">
          {options.map((option) => (
            <button
              ...
              className={cn(
                "flex w-full items-center justify-between rounded-lg px-4 py-3 text-left transition-colors min-h-[44px] select-none",
                value === option.value
